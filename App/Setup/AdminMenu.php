...
class AdminMenu{
	 ...
	 * Properties.
	 */
	private $option_group = 'rje_skin_r002_lp';
	private $option_name;
	...
	public function admin_menu() {
		add_options_page(
			__( '[RUI-JIN-EN Skin] Type LP(R002)', RJE_SKIN_R002_LP_A_TEXTDOMAIN ),
			__( '[RUI-JIN-EN Skin] Type LP(R002)', RJE_SKIN_R002_LP_A_TEXTDOMAIN ),
			'manage_options',
			...
			function() {
				?>
				<div class="wrap">
					<h1><?php esc_html_e( '[RUI-JIN-EN Skin] Type LP(R002)', RJE_SKIN_R002_LP_A_TEXTDOMAIN ); ?></h1>
	...
	public function admin_init() {
		...
		add_settings_section(
			...
			__( 'Recommended settings for Snow Monkey customization items', RJE_SKIN_R002_LP_A_TEXTDOMAIN ), //テキスト.
			function() {
				?>
		...
		add_settings_field(
			...
			__( '自動設定を有効にする', RJE_SKIN_R002_LP_A_TEXTDOMAIN ),
			function() {
